...
#ifndef INCLUDE_DRIVER_BB7_TRANSPOSE7_H
#define INCLUDE_DRIVER_BB7_TRANSPOSE7_H
...
#define L1_CACHE_SIZE ((u8) 4)  // ((u32)((1 << 15) / (8 * sizeof(cacheline))))
...
#endif /* INCLUDE_DRIVER_BB7_TRANSPOSE7_H */
