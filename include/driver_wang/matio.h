...
#ifndef INCLUDE_MATIO_H
#define INCLUDE_MATIO_H
...
template<class valT>
int read_mtx_mat(int &m, int &n, int &nnzA, int *&csrRowPtrA, int *&csrColIdxA, valT *&csrValA, const char *filename)
{
    int ret_code;
    MM_typecode matcode;
    FILE *f;
