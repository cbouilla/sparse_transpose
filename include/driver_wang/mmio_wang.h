...
#ifndef INCLUDE_MMIO_WANG_H
#define INCLUDE_MMIO_WANG_H
...
int mm_read_mtx_crd_data(FILE *f, __attribute__((unused)) int M, __attribute__((unused)) int N, int nz, int I[], int J[],
        double val[], MM_typecode matcode)
{
    int i;
    if (mm_is_complex(matcode))
